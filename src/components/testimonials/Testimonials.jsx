  ...
  return (
    <div className='recommendations'>
      <section id='experience'>
        <h5>Don't just listen to me...</h5>
        <h2>Testimonials</h2>

        {/* Carousel Wrapper */}
        <div className="recommendations__carousel-wrapper" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  <div className="recommendations__card__who">
                    ...
                    <div className="recommendations__card__info">
                      <h4 className="recommendations__card__name">{rec.name}</h4>
                      <h5 className="recommendations__card__role">{rec.role}</h5>
                      <h6 className="recommendations__card__relationship">{rec.relationship}</h6>
          ...
          <div className="recommendations__nav">
            <button className="recommendations__nav-arrow left-arrow" onClick={prevSlide}>
              <FaAngleLeft />
            </button>
            <button className="recommendations__nav-arrow right-arrow" onClick={nextSlide}>
              <FaAngleRight />
            </button>
          </div>
        ...
        <div className="recommendations__dots">
          {recommendations.map((_, index) => (
            <span
              key={index}
              className={`recommendations__dots-dot ${index === currentIndex ? "active" : ""}`}
